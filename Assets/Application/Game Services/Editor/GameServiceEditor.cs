...
public class ServiceEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        gameServiceManager = FindManager(out var errorMessage);
        bool onManager = gameServiceManager != null && gameServiceManager.ContainsService(GameService);
        ...
        {
            gameServiceManager.AddService(GameService);
            EditorUtility.SetDirty(gameServiceManager);
